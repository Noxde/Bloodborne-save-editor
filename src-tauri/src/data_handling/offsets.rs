...
impl Offsets {
    ...
    pub fn build(bytes: &Vec<u8>) -> Result<Offsets, Error> {
        ...
        inventory_offset.1 = username_offset + USERNAME_TO_INV_OFFSET + 1983 * 16; // source for the 1984 slots: https://www.bloodborne-wiki.com/2024/02/full-storage-glitch.html        key_inventory_offset.1 = find_end(key_inventory_offset.0, false)?;
